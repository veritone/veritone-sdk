...
export default {
	...
	getLibraryEngineModel: generateHandler(
		'GET',
		`${endpoints.libraries}/library/:libraryId/engine-model/:libraryEngineModelId`
	),
	...
	getEntityIdentifier: generateHandler(
		'GET',
		`${endpoints.libraries}/library/:libraryId/entity/:entityId/identifier/:entityIdentifierId`
	),
	...
	uploadEntityIdentifier: generateHandler(
		'POST',
		`'${endpoints.libraries}/library/:libraryId/entity/:entityId/identifier/:entityIdentifierTypeId`,
		['Content-Type']
	),
