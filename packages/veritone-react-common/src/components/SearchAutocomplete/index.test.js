...
import { SearchAutocompleteContainer } from './';
import { SearchAutocompleteDownshift } from './';
...
describe('SearchAutocompleteContainer', () => {
  ...
  it('SearchAutocompleteContainer: Should render with the default value filled in', () => {
  ...
  it('SearchAutocompleteContainer: Should render with the default value filled in', () => {
    ...
    wrapper.find('TextField').first().simulate('click', { preventDefault() {} });
