...
describe('Filters', function() {
  it('Should render a Header', function() {
    const wrapper = mount(<Filters {...defaultProps} />);
  ...
  it('should call props.onClearAllFilters when the rightIconButton is clicked', function() {
    ...
    const wrapper = mount(
      <Filters {...defaultProps} clearAllFilters onClearAllFilters={handler} />
    );
  ...
  it('should show the filters tree if props.selectedTab is Filters', function() {
    const wrapper = mount(<Filters {...defaultProps} selectedTab="Filters" />);
  ...
  it('should show the browse container if props.selectedTab is Browse', function() {
    const wrapper = mount(<Filters {...defaultProps} selectedTab="Browse" />);
  ...
  it('should not show the AllFiltersList if props.filters.length === 0', function() {
    const wrapper = mount(
      <Filters {...defaultProps} selectedTab="Filters" selectedFilters={[]} />
    );
