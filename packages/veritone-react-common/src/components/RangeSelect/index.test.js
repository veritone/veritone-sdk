...
describe('RangeSelect', () => {
    ...
    it('Should render min max with random value filled in', () => {
        ...
        expect(wrapper.find('.value-min').text()).toEqual(String(selectedConfidenceRange[0]));
        expect(wrapper.find('.value-max').text()).toEqual(String(selectedConfidenceRange[1]));
    });
