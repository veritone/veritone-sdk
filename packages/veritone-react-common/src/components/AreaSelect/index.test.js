...
describe('AreaSelect', () => {
  ...
  it('Should render with the default value filled in', () => {
    ...
    expect(testInstance.findByProps({ ['data-test']: "introText" }).children).toEqual([stepIntro[1]]);
  ...
  it('Should render with the step 2', () => {
    ...
    const testInstance = testRenderer.root;
    expect(testInstance.findByProps({ ['data-test']: "introText" }).children).toEqual([stepIntro[2]]);
