...
describe('TimeSearchModal', () => {
  it('Should render with the set input time', () => {
    ...
    expect( wrapper.find(".dayPartStartTimeInput").instance().value ).toEqual('01:02');
    expect( wrapper.find(".dayPartEndTimeInput").instance().value ).toEqual('03:04');
  ...
  it('Should render with the set input time and station broadcast days', () => {
    ...
    expect( wrapper.find(".dayPartStartTimeInput").instance().value ).toEqual('01:02');
    expect( wrapper.find(".dayPartEndTimeInput").instance().value ).toEqual('03:04');
    expect( wrapper.find(".stationBroadcastSwitch").find("input").instance().checked ).toEqual(true);
    expect( wrapper.find(".dayOfWeekSelection").find("input").at(0).instance().checked ).toEqual(false);
    expect( wrapper.find(".dayOfWeekSelection").find("input").at(1).instance().checked ).toEqual(false);
    expect( wrapper.find(".dayOfWeekSelection").find("input").at(2).instance().checked ).toEqual(true);
    expect( wrapper.find(".dayOfWeekSelection").find("input").at(3).instance().checked ).toEqual(true);
    expect( wrapper.find(".dayOfWeekSelection").find("input").at(4).instance().checked ).toEqual(true);
    expect( wrapper.find(".dayOfWeekSelection").find("input").at(5).instance().checked ).toEqual(true);
    expect( wrapper.find(".dayOfWeekSelection").find("input").at(6).instance().checked ).toEqual(true);
    expect( wrapper.find("button.timeSearchSubmit").instance().disabled ).toEqual(false);
  });
  ...
  it('Expect onDayPartStartTimeChange to be called when start time is changed', () => {
    ...
    wrapper.find(".dayPartStartTimeInput").simulate('change', { target: { value: '02:02' } });
  ...
  it('Expect onDayPartEndTimeChange to be called when end time is changed', () => {
    ...
    wrapper.find(".dayPartEndTimeInput").simulate('change', { target: { value: '02:02' } });
  ...
  it('Expect onDayOfWeekSelectionChange to be called when day of week is selected', () => {
    ...
    wrapper.find(".dayOfWeekSelection").find("input").at(0).simulate('change', { target: { checked: false } });
