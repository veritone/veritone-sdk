...
import { TranscriptSearchForm as DocumentSearchForm } from './';
...
describe('DocumentSearchModal', () => {
  ...
  //   expect( wrapper.find("button.transcriptSubmit").instance().disabled ).toEqual(false);
  // });

  // it('Search button should be disabled when opened with no initial state', () => {
  //   const wrapper = mount(<DocumentSearchForm />);
  //   expect( wrapper.find("button.transcriptSubmit").instance().disabled ).toEqual(true);
  // });
  ...
  //   expect( wrapper2.find("button.transcriptSubmit").instance().disabled ).toEqual(false);
  // });

  // it('Expect cancel button to call cancel function', () => {
  //   const cancel = jest.fn();
  //   let wrapper = mount(<DocumentSearchForm cancel={ cancel } />);
  ...
  it('Except onKeyPress to be called when a search phrase has been entered ', () => {
    ...
    let wrapper = mount(<DocumentSearchForm onKeyPress={ keypress } />);
  ...
  //   let wrapper = mount(<DocumentSearchForm onSubmit={ submit } inputValue="lakers"/>);
