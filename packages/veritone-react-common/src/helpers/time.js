export function msToReadableString(
  ...
  formattedString +=
    numMinutes.toLocaleString(undefined, { minimumIntegerDigits: 2 }) + ':';
  formattedString += numSeconds.toLocaleString(undefined, {
  ...
  if (showMilliseconds) {
    ...
    formattedString +=
      ':' +
      numMilliseconds.toLocaleString(undefined, { minimumIntegerDigits: 3 });
  }
