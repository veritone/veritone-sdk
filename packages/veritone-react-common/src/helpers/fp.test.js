...
describe('FP helpers', () => {
  describe('intersperse', () => {
    it('intersperses a constant in an array (even length)', () => {
    ...
    it('intersperses a constant in an array (odd length)', () => {
    ...
    it('intersperses a function in an array', () => {
      const a = ['one', 'two', 'three'];
    ...
    it('returns one value given one value array', () => {
    ...
    it('returns empty array given falsy', () => {
