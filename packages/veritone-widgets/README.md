...
* onLogout: func, called when the user clicks "logout". Apps must implmenet their own logout logic (usually by deleting the stored oauth token and redirecting or refreshing the page appropriately)
