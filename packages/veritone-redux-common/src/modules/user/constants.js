...
export const RESET_USER_PASSWORD_SUCCESS = 'vtn/user/RESET_USER_PASSWORD_SUCCESS';
export const RESET_USER_PASSWORD_FAILURE = 'vtn/user/RESET_USER_PASSWORD_FAILURE';
