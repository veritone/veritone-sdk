...
export const FETCH_USER_SETTINGS_SUCCESS =
  'vtn/user/FETCH_USER_SETTINGS_SUCCESS';
export const FETCH_USER_SETTINGS_FAILURE =
  'vtn/user/FETCH_USER_SETTINGS_FAILURE';

export const UPDATE_USER_SETTING = 'vtn/user/UPDATE_USER_SETTING';
export const UPDATE_USER_SETTING_SUCCESS =
  'vtn/user/UPDATE_USER_SETTING_SUCCESS';
export const UPDATE_USER_SETTING_FAILURE =
  'vtn/user/UPDATE_USER_SETTING_FAILURE';
